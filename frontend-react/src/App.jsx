  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        success = await signup(formData.email, formData.password, formData.name, formData.username);
      }
      ...
      <div className="max-w-md w-full space-y-6">
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl sm:text-4xl font-bold text-white">
            {isLogin ? 'Welcome Back!' : 'Join Safe Circle'}
          </h2>
          ...
          <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              <p className="text-xs text-gray-500 bg-blue-50 rounded-lg py-3 px-4 border border-blue-200">
                ...
                • Account data stored locally in your browser<br />
